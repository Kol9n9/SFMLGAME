    ...
    : Enemy("resouces/rat.png",sf::IntRect(18,42,21,23),pos)
{
    ...
    this->m_hp_bar = new GUI::Progressbar(sf::Vector2f(this->m_position.x,this->m_position.y-10),sf::Vector2f(this->m_hitbox->getHitbox().getSize().x,5),sf::Color(255,255,255),sf::Color(255,0,0),sf::Color(255,0,0));
