...
int main()
{
    ...
    GUI::Label *list_up = new GUI::Label(sf::Vector2f(300,165),L"Вверх",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0));
    GUI::Label *list_down = new GUI::Label(sf::Vector2f(300,201),L"Вниз",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0));
    GUI::Label *list_insert = new GUI::Label(sf::Vector2f(6,147),L"Добавить",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0));
    GUI::Label *list_del = new GUI::Label(sf::Vector2f(6,180),L"Удалить",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0));
    GUI::Label *list_clear = new GUI::Label(sf::Vector2f(3,218),L"Очистить",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0));
    GUI::Label *info_1 = new GUI::Label(sf::Vector2f(9,6),L"Двигать элементы",&font,15,sf::Color(0,0,0),sf::Color(0,0,0),sf::Color(0,0,0));
    GUI::Label *info_2 = new GUI::Label(sf::Vector2f(25,41),L"Изменить размер",&font,15,sf::Color(0,0,0),sf::Color(0,0,0),sf::Color(0,0,0));
    GUI::Label *info_3 = new GUI::Label(sf::Vector2f(60,84),L"Debug mode",&font,15,sf::Color(0,0,0),sf::Color(0,0,0),sf::Color(0,0,0));
    GUI::Label *timer_1 = new GUI::Label(sf::Vector2f(319,7),L"Перезапустить",&font,15,sf::Color(0,0,0),sf::Color(127,127,127),sf::Color(0,0,0));
    GUI::Label *timer_2 = new GUI::Label(sf::Vector2f(319,81),L"Перезапустить",&font,15,sf::Color(0,0,0),sf::Color(127,127,127),sf::Color(0,0,0));
    GUI::List *list1 = new GUI::List(sf::Vector2f(136,148),sf::Vector2f(150,102),sf::Color(0,255,0),sf::Color(127,127,0),sf::Color(0,0,255));
    GUI::List *list2 = new GUI::List(sf::Vector2f(200,20),sf::Vector2f(350,130),sf::Color(0,255,0),sf::Color(127,127,0),sf::Color(0,0,255));
    GUI::Droplist *drop1 = new GUI::Droplist(sf::Vector2f(136,280),sf::Vector2f(150,30),sf::Color(255,255,255),sf::Color(127,127,127),sf::Color(0,0,255));
    GUI::Checkbox *check = new GUI::Checkbox(sf::Vector2f(161,6),20,sf::Color(0,0,0),sf::Color(127,127,127),sf::Color(0,255,0));
    GUI::Checkbox *check2 = new GUI::Checkbox(sf::Vector2f(161,42),20,sf::Color(0,0,0),sf::Color(127,127,127),sf::Color(0,255,0));
    GUI::Checkbox *check3 = new GUI::Checkbox(sf::Vector2f(161,81),20,sf::Color(0,0,0),sf::Color(127,127,127),sf::Color(0,255,0));
    GUI::Progressbar *progress = new GUI::Progressbar(sf::Vector2f(206,7),sf::Vector2f(100,20),sf::Color(255,255,255),sf::Color(127,127,127),sf::Color(0,255,0));
    GUI::Progressbar *progress2 = new GUI::Progressbar(sf::Vector2f(204,36),50,sf::Color(255,255,255),sf::Color(127,127,127),sf::Color(0,255,0));
    GUI::Button *but1 = new GUI::Button(sf::Vector2f(447,10),sf::Vector2f(120,50),
                    new GUI::Label(sf::Vector2f(0,0),"New Game",&font,25,sf::Color(0,0,0),sf::Color(0,255,255),sf::Color(255,255,255)),
                    true, sf::Color(0,255,255),sf::Color(255,255,255),sf::Color(255,255,255));
    GUI::TextInput *textinput = new GUI::TextInput(sf::Vector2f(109,335),sf::Vector2f(200,20),&font,20,sf::Color(0,0,0),sf::Color(0,0,255),sf::Color(0,0,255));
    ...
    //list1->setItemCount();
    list1->insert(new GUI::Label(sf::Vector2f(0,40),L"Строка 1",&font,20,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0)));
    list1->insert(new GUI::Label(sf::Vector2f(0,40),L"Строка 2",&font,20,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0)));
    list2->insert(new GUI::Label(sf::Vector2f(0,40),"800x600",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0)),changeResolution,new Resolution(window,"800x600",800,600));
    list2->insert(new GUI::Label(sf::Vector2f(0,40),"1024x768",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0)),changeResolution,new Resolution(window,"1024x768",1024,768));
    list2->insert(new GUI::Label(sf::Vector2f(0,40),"1920x1080",&font,25,sf::Color(0,0,0),sf::Color(127,127,0),sf::Color(0,0,0)),changeResolution,new Resolution(window,"1920x1080",1920,1080));
